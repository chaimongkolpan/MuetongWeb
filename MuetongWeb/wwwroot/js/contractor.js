...
function editClick(id) {
    ...
    var jqxhr = $.get(url)
        .done(function (response) {
            ...
            $('#edit_directorname').val(response.directorName);
        })
        .fail(function (response) {
            console.log(response);
        });
...
function deleteClick(id, name) {
    $('#delete_id').val(id);
    $('#delete_text').html('ท่านต้องการลบผู้รับเหมา ' + name + ' ใช่หรือไม่ ?');
}
...
$('#add_btn').click(function () {
    ...
    request.append("Type", $('#add_type').val());
    ...
    request.append("DirectorName", $('#add_directorname').val());
...
$('#edit_btn').click(function () {
    ...
    request.append("DirectorName", $('#edit_directorname').val());
