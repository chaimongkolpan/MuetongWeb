...
function createTable() {
    ...
    if (poColl.all != null) {
        ...
        for (var i in poColl.all) {
            ...
            html += '<td class="bgpo" ' + rowspan + '><span class="material-symbols-outlined" onclick="edit_po(' + i + ')" style="color:#0752AE;" data-bs-toggle="modal" data-bs-target="#ActionApprovePurchase">view_list</span></td>';
            html += '<td class="bgpo" ' + rowspan + '><span class="material-symbols-outlined" onclick="cancel_po(' + i + ')" style="color:#A42206;" data-bs-toggle="modal" data-bs-target="#ActionCancel">delete</span></td>';
